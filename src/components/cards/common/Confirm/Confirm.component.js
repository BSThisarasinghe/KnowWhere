...
const Confirm = ({ children, visible, onAccept, onTouch, onCancel, buttonText, cardSectionStyle, header, modalStyle, cancelButtonText, containerStyle, headerStyle, subContainerStyle, cancelButtonStyle, buttonStyle, cancelButtonTextStyle, buttonTextStyle }) => {
    return (
        <Modal
            visible={visible}
            transparent
